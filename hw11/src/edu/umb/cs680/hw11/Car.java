...
public class Car {
    ...
    public void setDominationCount(ArrayList<Car> cars) {
        ...
        for (Car car : cars) {
            boolean a= car.getMileage() <= this.getMileage() && car.getPrice() <= this.getPrice() && car.getYear() >= this.getYear();
            boolean b=car.getMileage() < this.getMileage() || car.getPrice() < this.getPrice() || car.getYear() > this.getYear();
            if(a) {
                if(b) {
                    dc++;
                }
