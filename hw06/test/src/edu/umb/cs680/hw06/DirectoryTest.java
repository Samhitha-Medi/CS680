...
class DirectoryTest  {
    ...
    public void test_countChildren(){
        ...
        int exp=4;
        assertEquals(exp,b1.getChildren().size());
    }

    @Test
    public void test_getTotalsize(){
        Directory d1=TextFixtureInitialiser.fs.getRootDirs().get(0);
        assertEquals(150,d1.getTotalSize());
    }
    ...
    public void test_getSubd(){
        ...
        assertEquals("lib",sd.get(1).getName());
    }
    ...
    public void test_getFile(){
        ...
        assertEquals("a",f.get(0).getName());
